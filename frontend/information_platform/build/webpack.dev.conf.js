...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    before(app){
      ...
      app.get('/api/announcement/new', (req, res) => {
        res.json(announcement_new)
      })
      app.get('/api/lostafound/board', (req, res) => {
        res.json(lostafound_board)
      })
      app.get('/api/lostafound/myboard', (req, res) => {
        res.json(lostafound_myboard)
      })
      app.post('/api/lostafound/delete', (req, res) => {
        res.json(lostafound_delete)
      })
      app.post('/api/lostafound/publish', (req, res) => {
        res.json(lostafound_publish)
      })
      app.get('/api/manage/user', (req, res) => {
        res.json(manage_user)
      })
      app.post('/api/manage/user/password', (req, res) => {
        res.json(manage_user_password)
      })
      app.post('/api/manage/user/forbid', (req, res) => {
        res.json(manage_user_forbid)
      })
      app.post('/api/manage/user/release', (req, res) => {
        res.json(manage_user_release)
      })
      app.get('/api/manage/forum', (req, res) => {
        res.json(manage_forum)
      })
      app.post('/api/manage/forum/delete', (req, res) => {
        res.json(manage_forum_delete)
      })
      app.get('/api/manage/inbox/report', (req, res) => {
        res.json(manage_inbox_report)
      })
      app.get('/api/manage/inbox/appeal', (req, res) => {
        res.json(manage_inbox_appeal)
      })
      app.get('/api/manage/announcement', (req, res) => {
        res.json(manage_announcement)
      })
      app.post('/api/manage/announcement/delete', (req, res) => {
        res.json(manage_announcement_delete)
      })
      app.post('/api/manage/announcement/publish', (req, res) => {
        res.json(manage_announcement_publish)
      })
      app.post('/api/ifmanage', (req, res) => {
        res.json(manage_if)
      })
    }
    // mock code
